...
def main(page: Page):
    ...
    fte_data_upload_button = ElevatedButton(
        ...
        on_click=lambda _: pick_data_files_dialog.pick_files(
            initial_directory=data_directory, allow_multiple=False
        ),
    )
    ...
    pick_optional_report_files_dialog = FilePicker(
        on_result=optional_report_files_result
    )
                ...
                controls=[
                    Column(
                        ...
                        controls=[
                            Card(
                                content=Container(
                                    Text("Upload FTE monthly data", weight="bold"),
                                    padding=20,
                                    bgcolor=Colors.BLUE,
                                )
                            ),
                            ...
                            Row(
                                [
                                    IconButton(
                                        Icons.REMOVE, on_click=minus_fte_data_date_click
                                    ),
                                    fte_data_month_text,
                                    IconButton(
                                        Icons.ADD, on_click=plus_fte_data_date_click
                                    ),
                                ],
                ...
                controls=[
                    Column(
                        ...
                        controls=[
                            Card(
                                content=Container(
                                    Text("Generate FTE Reports", weight="bold"),
                                    padding=20,
                                    bgcolor=Colors.BLUE,
                                )
                            ),
                            ...
                            Row(
                                [
                                    IconButton(
                                        Icons.REMOVE,
                                        on_click=minus_report_start_month_click,
                                    ),
                                    generate_report_start_month_text,
                                    IconButton(
                                        Icons.ADD,
                                        on_click=plus_report_start_month_click,
                                    ),
                                ],
                                alignment=MainAxisAlignment.CENTER,
                            ),
